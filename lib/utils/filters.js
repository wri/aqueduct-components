...
function getObjectConversion() {
  ...
  var conversions = {
    ...
    commodity: function commodity(key, isSql) {
      return {
    ...
    water_column: function water_column(param) {
      var isWidget = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      return {
        key: param.key,
