  ...
  */
  ...
  _createClass(RadioGroup, [{
    ...
    value: function render() {
      ...
      var className = (0, _classnames3.default)(_defineProperty({}, this.props.className, !!this.props.className));

      return _react2.default.createElement(
        'div',
        { className: 'c-radio-box ' + className },
        items.map(function (item, i) {
          return _react2.default.createElement(
            'div',
            { key: i, className: 'c-radio ' + className },
