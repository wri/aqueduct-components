...
var DropdownButton = function (_React$Component) {
  ...
  _createClass(DropdownButton, [{
    ...
    value: function render() {
      ...
      var dropdownClasses = (0, _classnames3.default)(_defineProperty({
        'dropdown-menu': true
      ...
      return _react2.default.createElement(
        ...
        this.state.closed || _react2.default.createElement(
          'ul',
          { id: 'test', role: 'menu', className: dropdownClasses },
          this.props.options.map(function (item, index) {
            ...
            return _react2.default.createElement(
              ...
              item.component ? _react2.default.createElement(item.component, item) : item.label
            );
          })
        )
      );
