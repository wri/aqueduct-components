...
var Sticky = function (_React$Component) {
  ...
  _createClass(Sticky, [{
    ...
    value: function _onScroll() {
      ...
      var currentScroll = this.ScrollElem !== window ? this.ScrollElem.scrollTop : this.ScrollElem.scrollY;
      ...
      if (this.props.bottomLimit) {
        if (currentScroll >= this.props.topLimit && currentScroll < this.props.bottomLimit && this.state.isSticked === false) {
          this.setState({ isSticked: true }, function () {
            if (_this3.props.onStick) _this3.props.onStick(_this3.state.isSticked);
          });
        }
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames3.default)('c-sticky', this.props.className, _defineProperty({}, this.props.customFixedClassName, this.state.isSticked))
        },
        this.props.children
      );
    }
