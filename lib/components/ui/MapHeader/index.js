...
var MapHeader = function (_React$Component) {
  ...
  _createClass(MapHeader, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(0, _isEqual2.default)(this.props.filters, nextProps.filters);
    }
  }, {
    key: 'updateText',
    value: function updateText(props) {
      ...
      this.setState({
        text: (0, _utils.substitution)(props.template, params)
      });
    }
  }, {
    key: 'parseFilters',
    value: function parseFilters(filters) {
      ...
      Object.keys(filters).forEach(function (key) {
        if (Object.hasOwnProperty.call(_this2.props.dictionary, key)) {
          parsedFilters.push({ key: key, value: _this2.props.dictionary[key](filters[key]) });
        }
      });
