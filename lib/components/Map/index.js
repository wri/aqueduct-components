...
var Map = function (_React$Component) {
  ...
  _createClass(Map, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.layersActive && nextProps.layersActive.length && this.props.filters.food !== 'none' && this.props.mapConfig.zoom !== nextProps.mapConfig.zoom) {
    ...
    key: 'addMarkers',
    value: function addMarkers(layerId, zoom) {
      var layerConfig = {
        id: layerId,
        zoom: zoom
      };
